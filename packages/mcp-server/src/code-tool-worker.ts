...
import { Coingecko, ClientOptions } from '@coingecko/coingecko-typescript';
...
const fuse = new Fuse(
  [
    ...
    'client.coins.supplyBreakdown.get',
    ...
    'client.onchain.networks.pools.trades.getRange',
    ...
    'client.onchain.networks.tokens.topTraders.get',
    'client.onchain.networks.tokens.trades.get',
    'client.onchain.networks.tokens.trades.getRange',
    'client.onchain.networks.trendingPools.get',
    'client.onchain.networks.trendingPools.getNetwork',
    'client.onchain.networks.wallets.transfers.get',
    ...
    'client.onchain.simple.tokenPrice.getMulti',
    'client.onchain.tokens.getMulti',
    'client.onchain.tokens.infoRecentlyUpdated.get',
    'client.onchain.wallets.balances.get',
    'client.ping.get',
    'client.publicTreasury.getCoinID',
    'client.publicTreasury.getEntityID',
    'client.publicTreasury.getHoldingChart',
    'client.publicTreasury.getTransactionHistory',
    'client.rwas.getID',
    'client.rwas.getList',
    'client.rwas.getMarkets',
    'client.rwas.issuers.getID',
    'client.rwas.issuers.getList',
    'client.rwas.marketChart.get',
