...
const localDenoHandler = async ({
  ...
  try {
    const sdkPkgName = '@coingecko/coingecko-typescript';
  ...
  try {
    const resp = await new Promise<Response>((resolve, reject) => {
      ...
      const opts = {
        ...
        ...(client.proAPIKey != null ? { proAPIKey: client.proAPIKey } : undefined),
        ...(client.demoAPIKey != null ? { demoAPIKey: client.demoAPIKey } : undefined),
        defaultHeaders: {
