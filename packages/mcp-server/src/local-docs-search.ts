...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    markdown:
      "## get\n\n`client.coins.contract.get(id: string, contract_address: string): { id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; contract_address: string; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: object; last_updated: string; links: object; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: object[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; community_data?: object; developer_data?: object; localization?: object; market_data?: object; tickers?: object[]; }`\n\n**get** `/coins/{id}/contract/{contract_address}`\n\nTo query all the metadata (image, websites, socials, description, contract address, etc.) and market data (price, ATH, exchange tickers, etc.) of a coin based on an asset platform and a particular token contract address\n\n### Parameters\n\n- `id: string`\n\n- `contract_address: string`\n\n### Returns\n\n- `{ id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; contract_address: string; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: { large?: string; small?: string; thumb?: string; }; last_updated: string; links: { announcement_url?: string[]; bitcointalk_thread_identifier?: number; blockchain_site?: string[]; chat_url?: string[]; facebook_username?: string; homepage?: string[]; official_forum_url?: string[]; repos_url?: { bitbucket?: string[]; github?: string[]; }; snapshot_url?: string; subreddit_url?: string; telegram_channel_identifier?: string; twitter_screen_name?: string; whitepaper?: string; }; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: { category?: string; created_at?: string; description?: string; user?: string; user_title?: string; }[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; community_data?: { facebook_likes?: number; reddit_accounts_active_48h?: number; reddit_average_comments_48h?: number; reddit_average_posts_48h?: number; reddit_subscribers?: number; telegram_channel_user_count?: number; }; developer_data?: { closed_issues?: number; code_additions_deletions_4_weeks?: { additions?: number; deletions?: number; }; commit_count_4_weeks?: number; forks?: number; last_4_weeks_commit_activity_series?: number[]; pull_request_contributors?: number; pull_requests_merged?: number; stars?: number; subscribers?: number; total_issues?: number; }; localization?: object; market_data?: { ath?: object; ath_change_percentage?: object; ath_date?: object; atl?: object; atl_change_percentage?: object; atl_date?: object; circulating_supply?: number; current_price?: object; fdv_to_tvl_ratio?: number; fully_diluted_valuation?: object; high_24h?: object; last_updated?: string; low_24h?: object; market_cap?: object; market_cap_change_24h?: number; market_cap_change_24h_in_currency?: object; market_cap_change_percentage_24h?: number; market_cap_change_percentage_24h_in_currency?: object; market_cap_fdv_ratio?: number; market_cap_rank?: number; market_cap_rank_with_rehypothecated?: number; max_supply?: number; max_supply_infinite?: boolean; mcap_to_tvl_ratio?: number; outstanding_supply?: number; outstanding_token_value_usd?: number; price_change_24h?: number; price_change_24h_in_currency?: object; price_change_percentage_14d?: number; price_change_percentage_14d_in_currency?: object; price_change_percentage_1h_in_currency?: object; price_change_percentage_1y?: number; price_change_percentage_1y_in_currency?: object; price_change_percentage_200d?: number; price_change_percentage_200d_in_currency?: object; price_change_percentage_24h?: number; price_change_percentage_24h_in_currency?: object; price_change_percentage_30d?: number; price_change_percentage_30d_in_currency?: object; price_change_percentage_60d?: number; price_change_percentage_60d_in_currency?: object; price_change_percentage_7d?: number; price_change_percentage_7d_in_currency?: object; roi?: { currency?: string; percentage?: number; times?: number; }; sparkline_7d?: number[]; total_supply?: number; total_value_locked?: number; total_volume?: object; }; tickers?: { base?: string; bid_ask_spread_percentage?: number; coin_id?: string; coin_mcap_usd?: number; converted_last?: { btc?: number; eth?: number; usd?: number; }; converted_volume?: { btc?: number; eth?: number; usd?: number; }; is_anomaly?: boolean; is_stale?: boolean; last?: number; last_fetch_at?: string; last_traded_at?: string; market?: { has_trading_incentive?: boolean; identifier?: string; name?: string; }; target?: string; target_coin_id?: string; timestamp?: string; token_info_url?: string; trade_url?: string; trust_score?: string; volume?: number; }[]; }`\n\n  - `id: string`\n  - `additional_notices: string[]`\n  - `asset_platform_id: string`\n  - `block_time_in_minutes: number`\n  - `categories: string[]`\n  - `contract_address: string`\n  - `country_origin: string`\n  - `description: object`\n  - `detail_platforms: object`\n  - `genesis_date: string`\n  - `has_supply_breakdown: boolean`\n  - `hashing_algorithm: string`\n  - `image: { large?: string; small?: string; thumb?: string; }`\n  - `last_updated: string`\n  - `links: { announcement_url?: string[]; bitcointalk_thread_identifier?: number; blockchain_site?: string[]; chat_url?: string[]; facebook_username?: string; homepage?: string[]; official_forum_url?: string[]; repos_url?: { bitbucket?: string[]; github?: string[]; }; snapshot_url?: string; subreddit_url?: string; telegram_channel_identifier?: string; twitter_screen_name?: string; whitepaper?: string; }`\n  - `market_cap_rank: number`\n  - `market_cap_rank_with_rehypothecated: number`\n  - `name: string`\n  - `platforms: object`\n  - `preview_listing: boolean`\n  - `public_notice: string`\n  - `sentiment_votes_down_percentage: number`\n  - `sentiment_votes_up_percentage: number`\n  - `status_updates: { category?: string; created_at?: string; description?: string; user?: string; user_title?: string; }[]`\n  - `symbol: string`\n  - `watchlist_portfolio_users: number`\n  - `web_slug: string`\n  - `community_data?: { facebook_likes?: number; reddit_accounts_active_48h?: number; reddit_average_comments_48h?: number; reddit_average_posts_48h?: number; reddit_subscribers?: number; telegram_channel_user_count?: number; }`\n  - `developer_data?: { closed_issues?: number; code_additions_deletions_4_weeks?: { additions?: number; deletions?: number; }; commit_count_4_weeks?: number; forks?: number; last_4_weeks_commit_activity_series?: number[]; pull_request_contributors?: number; pull_requests_merged?: number; stars?: number; subscribers?: number; total_issues?: number; }`\n  - `localization?: object`\n  - `market_data?: { ath?: object; ath_change_percentage?: object; ath_date?: object; atl?: object; atl_change_percentage?: object; atl_date?: object; circulating_supply?: number; current_price?: object; fdv_to_tvl_ratio?: number; fully_diluted_valuation?: object; high_24h?: object; last_updated?: string; low_24h?: object; market_cap?: object; market_cap_change_24h?: number; market_cap_change_24h_in_currency?: object; market_cap_change_percentage_24h?: number; market_cap_change_percentage_24h_in_currency?: object; market_cap_fdv_ratio?: number; market_cap_rank?: number; market_cap_rank_with_rehypothecated?: number; max_supply?: number; max_supply_infinite?: boolean; mcap_to_tvl_ratio?: number; outstanding_supply?: number; outstanding_token_value_usd?: number; price_change_24h?: number; price_change_24h_in_currency?: object; price_change_percentage_14d?: number; price_change_percentage_14d_in_currency?: object; price_change_percentage_1h_in_currency?: object; price_change_percentage_1y?: number; price_change_percentage_1y_in_currency?: object; price_change_percentage_200d?: number; price_change_percentage_200d_in_currency?: object; price_change_percentage_24h?: number; price_change_percentage_24h_in_currency?: object; price_change_percentage_30d?: number; price_change_percentage_30d_in_currency?: object; price_change_percentage_60d?: number; price_change_percentage_60d_in_currency?: object; price_change_percentage_7d?: number; price_change_percentage_7d_in_currency?: object; roi?: { currency?: string; percentage?: number; times?: number; }; sparkline_7d?: number[]; total_supply?: number; total_value_locked?: number; total_volume?: object; }`\n  - `tickers?: { base?: string; bid_ask_spread_percentage?: number; coin_id?: string; coin_mcap_usd?: number; converted_last?: { btc?: number; eth?: number; usd?: number; }; converted_volume?: { btc?: number; eth?: number; usd?: number; }; is_anomaly?: boolean; is_stale?: boolean; last?: number; last_fetch_at?: string; last_traded_at?: string; market?: { has_trading_incentive?: boolean; identifier?: string; name?: string; }; target?: string; target_coin_id?: string; timestamp?: string; token_info_url?: string; trade_url?: string; trust_score?: string; volume?: number; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst contract = await client.coins.contract.get('contract_address', { id: 'id' });\n\nconsole.log(contract);\n```",
    perLanguage: {
      typescript: {
