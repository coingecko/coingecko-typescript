...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: object; last_updated: string; links: object; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: object[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; categories_details?: object[]; ico_data?: object; localization?: object; market_data?: object; tickers?: object[]; }',
    markdown:
      "## get_id\n\n`client.coins.getID(id: string, community_data?: boolean, developer_data?: boolean, dex_pair_format?: 'contract_address' | 'symbol', include_categories_details?: boolean, localization?: boolean, market_data?: boolean, sparkline?: boolean, tickers?: boolean): { id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: object; last_updated: string; links: object; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: object[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; categories_details?: object[]; ico_data?: object; localization?: object; market_data?: object; tickers?: object[]; }`\n\n**get** `/coins/{id}`\n\nTo query all the metadata (image, websites, socials, description, contract address, etc.) and market data (price, ATH, exchange tickers, etc.) of a coin based on a particular coin ID\n\n### Parameters\n\n- `id: string`\n\n- `community_data?: boolean`\n  Include community data. \nDeprecated: has no effect as of 28 August 2026; the `community_data` object is no longer returned.\n\n- `developer_data?: boolean`\n  Include developer data. \nDeprecated: has no effect as of 28 August 2026; the `developer_data` object is no longer returned.\n\n- `dex_pair_format?: 'contract_address' | 'symbol'`\n  Set to `symbol` to display DEX pair base and target as symbols. \nDefault: `contract_address`\n\n- `include_categories_details?: boolean`\n  Include categories details. \nDefault: false\n\n- `localization?: boolean`\n  Include all localized languages in the response. \nDefault: true\n\n- `market_data?: boolean`\n  Include market data. \nDefault: true\n\n- `sparkline?: boolean`\n  Include sparkline 7-day data. \nDefault: false\n\n- `tickers?: boolean`\n  Include tickers data. \nDefault: true\n\n### Returns\n\n- `{ id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: { large?: string; small?: string; thumb?: string; }; last_updated: string; links: { announcement_url?: string[]; bitcointalk_thread_identifier?: number; blockchain_site?: string[]; chat_url?: string[]; facebook_username?: string; homepage?: string[]; official_forum_url?: string[]; repos_url?: { bitbucket?: string[]; github?: string[]; }; snapshot_url?: string; subreddit_url?: string; telegram_channel_identifier?: string; twitter_screen_name?: string; whitepaper?: string; }; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: { category?: string; created_at?: string; description?: string; user?: string; user_title?: string; }[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; categories_details?: { id?: string; name?: string; }[]; ico_data?: { accepting_currencies?: string; amount_for_sale?: number; base_pre_sale_amount?: number; base_public_sale_amount?: number; bounty_detail_url?: string; country_origin?: string; description?: string; hardcap_amount?: number; hardcap_currency?: string; ico_end_date?: string; ico_start_date?: string; kyc_required?: boolean; links?: object; pre_sale_available?: boolean; pre_sale_end_date?: string; pre_sale_ended?: boolean; pre_sale_start_date?: string; quote_pre_sale_amount?: number; quote_pre_sale_currency?: string; quote_public_sale_amount?: number; quote_public_sale_currency?: string; short_desc?: string; softcap_amount?: number; softcap_currency?: string; total_raised?: number; total_raised_currency?: string; whitelist_available?: boolean; whitelist_end_date?: string; whitelist_start_date?: string; whitelist_url?: string; }; localization?: object; market_data?: { ath?: object; ath_change_percentage?: object; ath_date?: object; atl?: object; atl_change_percentage?: object; atl_date?: object; circulating_supply?: number; current_price?: object; fdv_to_tvl_ratio?: number; fully_diluted_valuation?: object; high_24h?: object; last_updated?: string; low_24h?: object; market_cap?: object; market_cap_change_24h?: number; market_cap_change_24h_in_currency?: object; market_cap_change_percentage_24h?: number; market_cap_change_percentage_24h_in_currency?: object; market_cap_fdv_ratio?: number; market_cap_rank?: number; market_cap_rank_with_rehypothecated?: number; max_supply?: number; max_supply_infinite?: boolean; mcap_to_tvl_ratio?: number; outstanding_supply?: number; outstanding_token_value_usd?: number; price_change_24h?: number; price_change_24h_in_currency?: object; price_change_percentage_14d?: number; price_change_percentage_14d_in_currency?: object; price_change_percentage_1h_in_currency?: object; price_change_percentage_1y?: number; price_change_percentage_1y_in_currency?: object; price_change_percentage_200d?: number; price_change_percentage_200d_in_currency?: object; price_change_percentage_24h?: number; price_change_percentage_24h_in_currency?: object; price_change_percentage_30d?: number; price_change_percentage_30d_in_currency?: object; price_change_percentage_60d?: number; price_change_percentage_60d_in_currency?: object; price_change_percentage_7d?: number; price_change_percentage_7d_in_currency?: object; roi?: { currency?: string; percentage?: number; times?: number; }; sparkline_7d?: number[]; total_supply?: number; total_value_locked?: number; total_volume?: object; }; tickers?: { base?: string; bid_ask_spread_percentage?: number; coin_id?: string; coin_mcap_usd?: number; converted_last?: { btc?: number; eth?: number; usd?: number; }; converted_volume?: { btc?: number; eth?: number; usd?: number; }; is_anomaly?: boolean; is_stale?: boolean; last?: number; last_fetch_at?: string; last_traded_at?: string; market?: { has_trading_incentive?: boolean; identifier?: string; name?: string; }; target?: string; target_coin_id?: string; timestamp?: string; token_info_url?: string; trade_url?: string; trust_score?: string; volume?: number; }[]; }`\n\n  - `id: string`\n  - `additional_notices: string[]`\n  - `asset_platform_id: string`\n  - `block_time_in_minutes: number`\n  - `categories: string[]`\n  - `country_origin: string`\n  - `description: object`\n  - `detail_platforms: object`\n  - `genesis_date: string`\n  - `has_supply_breakdown: boolean`\n  - `hashing_algorithm: string`\n  - `image: { large?: string; small?: string; thumb?: string; }`\n  - `last_updated: string`\n  - `links: { announcement_url?: string[]; bitcointalk_thread_identifier?: number; blockchain_site?: string[]; chat_url?: string[]; facebook_username?: string; homepage?: string[]; official_forum_url?: string[]; repos_url?: { bitbucket?: string[]; github?: string[]; }; snapshot_url?: string; subreddit_url?: string; telegram_channel_identifier?: string; twitter_screen_name?: string; whitepaper?: string; }`\n  - `market_cap_rank: number`\n  - `market_cap_rank_with_rehypothecated: number`\n  - `name: string`\n  - `platforms: object`\n  - `preview_listing: boolean`\n  - `public_notice: string`\n  - `sentiment_votes_down_percentage: number`\n  - `sentiment_votes_up_percentage: number`\n  - `status_updates: { category?: string; created_at?: string; description?: string; user?: string; user_title?: string; }[]`\n  - `symbol: string`\n  - `watchlist_portfolio_users: number`\n  - `web_slug: string`\n  - `categories_details?: { id?: string; name?: string; }[]`\n  - `ico_data?: { accepting_currencies?: string; amount_for_sale?: number; base_pre_sale_amount?: number; base_public_sale_amount?: number; bounty_detail_url?: string; country_origin?: string; description?: string; hardcap_amount?: number; hardcap_currency?: string; ico_end_date?: string; ico_start_date?: string; kyc_required?: boolean; links?: object; pre_sale_available?: boolean; pre_sale_end_date?: string; pre_sale_ended?: boolean; pre_sale_start_date?: string; quote_pre_sale_amount?: number; quote_pre_sale_currency?: string; quote_public_sale_amount?: number; quote_public_sale_currency?: string; short_desc?: string; softcap_amount?: number; softcap_currency?: string; total_raised?: number; total_raised_currency?: string; whitelist_available?: boolean; whitelist_end_date?: string; whitelist_start_date?: string; whitelist_url?: string; }`\n  - `localization?: object`\n  - `market_data?: { ath?: object; ath_change_percentage?: object; ath_date?: object; atl?: object; atl_change_percentage?: object; atl_date?: object; circulating_supply?: number; current_price?: object; fdv_to_tvl_ratio?: number; fully_diluted_valuation?: object; high_24h?: object; last_updated?: string; low_24h?: object; market_cap?: object; market_cap_change_24h?: number; market_cap_change_24h_in_currency?: object; market_cap_change_percentage_24h?: number; market_cap_change_percentage_24h_in_currency?: object; market_cap_fdv_ratio?: number; market_cap_rank?: number; market_cap_rank_with_rehypothecated?: number; max_supply?: number; max_supply_infinite?: boolean; mcap_to_tvl_ratio?: number; outstanding_supply?: number; outstanding_token_value_usd?: number; price_change_24h?: number; price_change_24h_in_currency?: object; price_change_percentage_14d?: number; price_change_percentage_14d_in_currency?: object; price_change_percentage_1h_in_currency?: object; price_change_percentage_1y?: number; price_change_percentage_1y_in_currency?: object; price_change_percentage_200d?: number; price_change_percentage_200d_in_currency?: object; price_change_percentage_24h?: number; price_change_percentage_24h_in_currency?: object; price_change_percentage_30d?: number; price_change_percentage_30d_in_currency?: object; price_change_percentage_60d?: number; price_change_percentage_60d_in_currency?: object; price_change_percentage_7d?: number; price_change_percentage_7d_in_currency?: object; roi?: { currency?: string; percentage?: number; times?: number; }; sparkline_7d?: number[]; total_supply?: number; total_value_locked?: number; total_volume?: object; }`\n  - `tickers?: { base?: string; bid_ask_spread_percentage?: number; coin_id?: string; coin_mcap_usd?: number; converted_last?: { btc?: number; eth?: number; usd?: number; }; converted_volume?: { btc?: number; eth?: number; usd?: number; }; is_anomaly?: boolean; is_stale?: boolean; last?: number; last_fetch_at?: string; last_traded_at?: string; market?: { has_trading_incentive?: boolean; identifier?: string; name?: string; }; target?: string; target_coin_id?: string; timestamp?: string; token_info_url?: string; trade_url?: string; trust_score?: string; volume?: number; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.coins.getID('bitcoin');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; contract_address: string; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: object; last_updated: string; links: object; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: object[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; localization?: object; market_data?: object; tickers?: object[]; }',
    markdown:
      "## get\n\n`client.coins.contract.get(id: string, contract_address: string): { id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; contract_address: string; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: object; last_updated: string; links: object; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: object[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; localization?: object; market_data?: object; tickers?: object[]; }`\n\n**get** `/coins/{id}/contract/{contract_address}`\n\nTo query all the metadata (image, websites, socials, description, contract address, etc.) and market data (price, ATH, exchange tickers, etc.) of a coin based on an asset platform and a particular token contract address\n\n### Parameters\n\n- `id: string`\n\n- `contract_address: string`\n\n### Returns\n\n- `{ id: string; additional_notices: string[]; asset_platform_id: string; block_time_in_minutes: number; categories: string[]; contract_address: string; country_origin: string; description: object; detail_platforms: object; genesis_date: string; has_supply_breakdown: boolean; hashing_algorithm: string; image: { large?: string; small?: string; thumb?: string; }; last_updated: string; links: { announcement_url?: string[]; bitcointalk_thread_identifier?: number; blockchain_site?: string[]; chat_url?: string[]; facebook_username?: string; homepage?: string[]; official_forum_url?: string[]; repos_url?: { bitbucket?: string[]; github?: string[]; }; snapshot_url?: string; subreddit_url?: string; telegram_channel_identifier?: string; twitter_screen_name?: string; whitepaper?: string; }; market_cap_rank: number; market_cap_rank_with_rehypothecated: number; name: string; platforms: object; preview_listing: boolean; public_notice: string; sentiment_votes_down_percentage: number; sentiment_votes_up_percentage: number; status_updates: { category?: string; created_at?: string; description?: string; user?: string; user_title?: string; }[]; symbol: string; watchlist_portfolio_users: number; web_slug: string; localization?: object; market_data?: { ath?: object; ath_change_percentage?: object; ath_date?: object; atl?: object; atl_change_percentage?: object; atl_date?: object; circulating_supply?: number; current_price?: object; fdv_to_tvl_ratio?: number; fully_diluted_valuation?: object; high_24h?: object; last_updated?: string; low_24h?: object; market_cap?: object; market_cap_change_24h?: number; market_cap_change_24h_in_currency?: object; market_cap_change_percentage_24h?: number; market_cap_change_percentage_24h_in_currency?: object; market_cap_fdv_ratio?: number; market_cap_rank?: number; market_cap_rank_with_rehypothecated?: number; max_supply?: number; max_supply_infinite?: boolean; mcap_to_tvl_ratio?: number; outstanding_supply?: number; outstanding_token_value_usd?: number; price_change_24h?: number; price_change_24h_in_currency?: object; price_change_percentage_14d?: number; price_change_percentage_14d_in_currency?: object; price_change_percentage_1h_in_currency?: object; price_change_percentage_1y?: number; price_change_percentage_1y_in_currency?: object; price_change_percentage_200d?: number; price_change_percentage_200d_in_currency?: object; price_change_percentage_24h?: number; price_change_percentage_24h_in_currency?: object; price_change_percentage_30d?: number; price_change_percentage_30d_in_currency?: object; price_change_percentage_60d?: number; price_change_percentage_60d_in_currency?: object; price_change_percentage_7d?: number; price_change_percentage_7d_in_currency?: object; roi?: { currency?: string; percentage?: number; times?: number; }; sparkline_7d?: number[]; total_supply?: number; total_value_locked?: number; total_volume?: object; }; tickers?: { base?: string; bid_ask_spread_percentage?: number; coin_id?: string; coin_mcap_usd?: number; converted_last?: { btc?: number; eth?: number; usd?: number; }; converted_volume?: { btc?: number; eth?: number; usd?: number; }; is_anomaly?: boolean; is_stale?: boolean; last?: number; last_fetch_at?: string; last_traded_at?: string; market?: { has_trading_incentive?: boolean; identifier?: string; name?: string; }; target?: string; target_coin_id?: string; timestamp?: string; token_info_url?: string; trade_url?: string; trust_score?: string; volume?: number; }[]; }`\n\n  - `id: string`\n  - `additional_notices: string[]`\n  - `asset_platform_id: string`\n  - `block_time_in_minutes: number`\n  - `categories: string[]`\n  - `contract_address: string`\n  - `country_origin: string`\n  - `description: object`\n  - `detail_platforms: object`\n  - `genesis_date: string`\n  - `has_supply_breakdown: boolean`\n  - `hashing_algorithm: string`\n  - `image: { large?: string; small?: string; thumb?: string; }`\n  - `last_updated: string`\n  - `links: { announcement_url?: string[]; bitcointalk_thread_identifier?: number; blockchain_site?: string[]; chat_url?: string[]; facebook_username?: string; homepage?: string[]; official_forum_url?: string[]; repos_url?: { bitbucket?: string[]; github?: string[]; }; snapshot_url?: string; subreddit_url?: string; telegram_channel_identifier?: string; twitter_screen_name?: string; whitepaper?: string; }`\n  - `market_cap_rank: number`\n  - `market_cap_rank_with_rehypothecated: number`\n  - `name: string`\n  - `platforms: object`\n  - `preview_listing: boolean`\n  - `public_notice: string`\n  - `sentiment_votes_down_percentage: number`\n  - `sentiment_votes_up_percentage: number`\n  - `status_updates: { category?: string; created_at?: string; description?: string; user?: string; user_title?: string; }[]`\n  - `symbol: string`\n  - `watchlist_portfolio_users: number`\n  - `web_slug: string`\n  - `localization?: object`\n  - `market_data?: { ath?: object; ath_change_percentage?: object; ath_date?: object; atl?: object; atl_change_percentage?: object; atl_date?: object; circulating_supply?: number; current_price?: object; fdv_to_tvl_ratio?: number; fully_diluted_valuation?: object; high_24h?: object; last_updated?: string; low_24h?: object; market_cap?: object; market_cap_change_24h?: number; market_cap_change_24h_in_currency?: object; market_cap_change_percentage_24h?: number; market_cap_change_percentage_24h_in_currency?: object; market_cap_fdv_ratio?: number; market_cap_rank?: number; market_cap_rank_with_rehypothecated?: number; max_supply?: number; max_supply_infinite?: boolean; mcap_to_tvl_ratio?: number; outstanding_supply?: number; outstanding_token_value_usd?: number; price_change_24h?: number; price_change_24h_in_currency?: object; price_change_percentage_14d?: number; price_change_percentage_14d_in_currency?: object; price_change_percentage_1h_in_currency?: object; price_change_percentage_1y?: number; price_change_percentage_1y_in_currency?: object; price_change_percentage_200d?: number; price_change_percentage_200d_in_currency?: object; price_change_percentage_24h?: number; price_change_percentage_24h_in_currency?: object; price_change_percentage_30d?: number; price_change_percentage_30d_in_currency?: object; price_change_percentage_60d?: number; price_change_percentage_60d_in_currency?: object; price_change_percentage_7d?: number; price_change_percentage_7d_in_currency?: object; roi?: { currency?: string; percentage?: number; times?: number; }; sparkline_7d?: number[]; total_supply?: number; total_value_locked?: number; total_volume?: object; }`\n  - `tickers?: { base?: string; bid_ask_spread_percentage?: number; coin_id?: string; coin_mcap_usd?: number; converted_last?: { btc?: number; eth?: number; usd?: number; }; converted_volume?: { btc?: number; eth?: number; usd?: number; }; is_anomaly?: boolean; is_stale?: boolean; last?: number; last_fetch_at?: string; last_traded_at?: string; market?: { has_trading_incentive?: boolean; identifier?: string; name?: string; }; target?: string; target_coin_id?: string; timestamp?: string; token_info_url?: string; trade_url?: string; trust_score?: string; volume?: number; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst contract = await client.coins.contract.get('contract_address', { id: 'id' });\n\nconsole.log(contract);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ id: string; image: { small?: string; thumb?: string; }; market_data: { current_price?: object; market_cap?: object; total_volume?: object; }; name: string; public_interest_stats: { alexa_rank?: number; bing_matches?: number; }; symbol: string; localization?: object; }',
    markdown:
      "## get\n\n`client.coins.history.get(id: string, date: string, localization?: boolean): { id: string; image: object; market_data: object; name: string; public_interest_stats: object; symbol: string; localization?: object; }`\n\n**get** `/coins/{id}/history`\n\nTo query the historical data (price, market cap, 24hrs volume, etc.) at a given date for a coin based on a particular coin ID\n\n### Parameters\n\n- `id: string`\n\n- `date: string`\n  The date of data snapshot. \nFormat: `YYYY-MM-DD`\n\n- `localization?: boolean`\n  Include all the localized languages in response. \nDefault: true\n\n### Returns\n\n- `{ id: string; image: { small?: string; thumb?: string; }; market_data: { current_price?: object; market_cap?: object; total_volume?: object; }; name: string; public_interest_stats: { alexa_rank?: number; bing_matches?: number; }; symbol: string; localization?: object; }`\n\n  - `id: string`\n  - `image: { small?: string; thumb?: string; }`\n  - `market_data: { current_price?: object; market_cap?: object; total_volume?: object; }`\n  - `name: string`\n  - `public_interest_stats: { alexa_rank?: number; bing_matches?: number; }`\n  - `symbol: string`\n  - `localization?: object`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst history = await client.coins.history.get('id', { date: 'date' });\n\nconsole.log(history);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'get',
    endpoint: '/coins/{id}/supply_breakdown',
    httpMethod: 'get',
    summary: 'Coin Supply Breakdown by ID',
    description: 'To query the supply breakdown of a coin based on provided coin ID',
    stainlessPath: '(resource) coins.supply_breakdown > (method) get',
    qualified: 'client.coins.supplyBreakdown.get',
    params: ['id: string;'],
    response:
      '{ id: string; name: string; non_circulating_wallets: { address?: string; anomaly?: boolean; balance?: number; label?: string; last_updated?: string; percentage_of_total_supply?: number; }[]; supply_data: { circulating_supply?: number; last_updated?: string; non_circulating_supply?: number; outstanding_supply?: number; total_supply?: number; }; symbol: string; }',
    markdown:
      "## get\n\n`client.coins.supplyBreakdown.get(id: string): { id: string; name: string; non_circulating_wallets: object[]; supply_data: object; symbol: string; }`\n\n**get** `/coins/{id}/supply_breakdown`\n\nTo query the supply breakdown of a coin based on provided coin ID\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; name: string; non_circulating_wallets: { address?: string; anomaly?: boolean; balance?: number; label?: string; last_updated?: string; percentage_of_total_supply?: number; }[]; supply_data: { circulating_supply?: number; last_updated?: string; non_circulating_supply?: number; outstanding_supply?: number; total_supply?: number; }; symbol: string; }`\n\n  - `id: string`\n  - `name: string`\n  - `non_circulating_wallets: { address?: string; anomaly?: boolean; balance?: number; label?: string; last_updated?: string; percentage_of_total_supply?: number; }[]`\n  - `supply_data: { circulating_supply?: number; last_updated?: string; non_circulating_supply?: number; outstanding_supply?: number; total_supply?: number; }`\n  - `symbol: string`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst supplyBreakdown = await client.coins.supplyBreakdown.get('id');\n\nconsole.log(supplyBreakdown);\n```",
    perLanguage: {
      typescript: {
        method: 'client.coins.supplyBreakdown.get',
        example:
          "import Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko({\n  proAPIKey: process.env['COINGECKO_PRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst supplyBreakdown = await client.coins.supplyBreakdown.get('id');\n\nconsole.log(supplyBreakdown.id);",
      },
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/coins/$ID/supply_breakdown \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'coins.supply_breakdown.get',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nsupply_breakdown = client.coins.supply_breakdown.get(\n    "id",\n)\nprint(supply_breakdown.id)',
      },
    },
  },
  {
    ...
    response:
      '{ name: string; tickers: { base: string; bid_ask_spread_percentage: number; coin_id: string; coin_mcap_usd: number; converted_last: { btc?: number; eth?: number; usd?: number; }; converted_volume: { btc?: number; eth?: number; usd?: number; }; is_anomaly: boolean; is_stale: boolean; last: number; last_fetch_at: string; last_traded_at: string; market: { has_trading_incentive?: boolean; identifier?: string; logo?: string; name?: string; }; target: string; target_coin_id: string; timestamp: string; token_info_url: string; trade_url: string; trust_score: string; volume: number; cost_to_move_down_usd?: number; cost_to_move_up_usd?: number; }[]; }',
    markdown:
  ...
  },
  {
    ...
    response:
      '{ top_gainers: { id: string; image: string; market_cap_rank: number; name: string; symbol: string; usd: number; usd_24h_change: number; usd_24h_vol: number; usd_14d_change?: number; usd_1h_change?: number; usd_1y_change?: number; usd_200d_change?: number; usd_30d_change?: number; usd_60d_change?: number; usd_7d_change?: number; }[]; top_losers: { id: string; image: string; market_cap_rank: number; name: string; symbol: string; usd: number; usd_24h_change: number; usd_24h_vol: number; usd_14d_change?: number; usd_1h_change?: number; usd_1y_change?: number; usd_200d_change?: number; usd_30d_change?: number; usd_60d_change?: number; usd_7d_change?: number; }[]; }',
    markdown:
      "## get\n\n`client.coins.topGainersLosers.get(vs_currency: string, duration?: '1h' | '24h' | '7d' | '14d' | '30d' | '60d' | '1y', price_change_percentage?: string, top_coins?: '300' | '500' | '1000' | 'all'): { top_gainers: top_gainers_losers_item[]; top_losers: top_gainers_losers_item[]; }`\n\n**get** `/coins/top_gainers_losers`\n\nTo query the top 30 coins with largest price gain and loss by a specific time duration\n\n### Parameters\n\n- `vs_currency: string`\n  Target currency of coins. \n*refers to [`/simple/supported_vs_currencies`](/reference/simple-supported-currencies)\n\n- `duration?: '1h' | '24h' | '7d' | '14d' | '30d' | '60d' | '1y'`\n  Filter result by time range. \nDefault: `24h`\n\n- `price_change_percentage?: string`\n  Include price change percentage timeframe, comma-separated if querying more than 1 timeframe. \nValid values: `1h`, `24h`, `7d`, `14d`, `30d`, `60d`, `200d`, `1y`\n\n- `top_coins?: '300' | '500' | '1000' | 'all'`\n  Filter result by market cap ranking (top 300 to 1000) or all coins (including coins that do not have market cap). \nDefault: `1000`\n\n### Returns\n\n- `{ top_gainers: { id: string; image: string; market_cap_rank: number; name: string; symbol: string; usd: number; usd_24h_change: number; usd_24h_vol: number; usd_14d_change?: number; usd_1h_change?: number; usd_1y_change?: number; usd_200d_change?: number; usd_30d_change?: number; usd_60d_change?: number; usd_7d_change?: number; }[]; top_losers: { id: string; image: string; market_cap_rank: number; name: string; symbol: string; usd: number; usd_24h_change: number; usd_24h_vol: number; usd_14d_change?: number; usd_1h_change?: number; usd_1y_change?: number; usd_200d_change?: number; usd_30d_change?: number; usd_60d_change?: number; usd_7d_change?: number; }[]; }`\n\n  - `top_gainers: { id: string; image: string; market_cap_rank: number; name: string; symbol: string; usd: number; usd_24h_change: number; usd_24h_vol: number; usd_14d_change?: number; usd_1h_change?: number; usd_1y_change?: number; usd_200d_change?: number; usd_30d_change?: number; usd_60d_change?: number; usd_7d_change?: number; }[]`\n  - `top_losers: { id: string; image: string; market_cap_rank: number; name: string; symbol: string; usd: number; usd_24h_change: number; usd_24h_vol: number; usd_14d_change?: number; usd_1h_change?: number; usd_1y_change?: number; usd_200d_change?: number; usd_30d_change?: number; usd_60d_change?: number; usd_7d_change?: number; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst topGainersLoser = await client.coins.topGainersLosers.get({ vs_currency: 'vs_currency' });\n\nconsole.log(topGainersLoser);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ basis: number; contract_type: string; expired_at: number; funding_rate: number; index: number; index_id: string; last_traded_at: number; market: string; open_interest: number; price: string; price_percentage_change_24h: number; spread: number; symbol: string; volume_24h: number; }[]',
    markdown:
      "## get\n\n`client.derivatives.get(): { basis: number; contract_type: string; expired_at: number; funding_rate: number; index: number; index_id: string; last_traded_at: number; market: string; open_interest: number; price: string; price_percentage_change_24h: number; spread: number; symbol: string; volume_24h: number; }[]`\n\n**get** `/derivatives`\n\nTo query all the tickers from derivatives exchanges on CoinGecko\n\n### Returns\n\n- `{ basis: number; contract_type: string; expired_at: number; funding_rate: number; index: number; index_id: string; last_traded_at: number; market: string; open_interest: number; price: string; price_percentage_change_24h: number; spread: number; symbol: string; volume_24h: number; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst derivatives = await client.derivatives.get();\n\nconsole.log(derivatives);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## get_id\n\n`client.derivatives.exchanges.getID(id: string, include_tickers?: 'all' | 'unexpired'): { country: string; description: string; image: string; name: string; number_of_futures_pairs: number; number_of_perpetual_pairs: number; open_interest_btc: number; trade_volume_24h_btc: string; url: string; year_established: number; tickers?: object[]; }`\n\n**get** `/derivatives/exchanges/{id}`\n\nTo query the derivatives exchange's related data (name, open interest, trade volume, ...) based on the exchange's ID\n\n### Parameters\n\n- `id: string`\n\n- `include_tickers?: 'all' | 'unexpired'`\n  Include tickers data. \nDefault: tickers data is not included.\n\n### Returns\n\n- `{ country: string; description: string; image: string; name: string; number_of_futures_pairs: number; number_of_perpetual_pairs: number; open_interest_btc: number; trade_volume_24h_btc: string; url: string; year_established: number; tickers?: { base: string; bid_ask_spread: number; coin_id: string; contract_type: string; converted_last: { btc?: string; eth?: string; usd?: string; }; converted_volume: { btc?: string; eth?: string; usd?: string; }; expired_at: number; funding_rate: number; h24_percentage_change: number; h24_volume: number; index: number; index_basis_percentage: number; last: number; last_traded: number; open_interest_usd: number; symbol: string; target: string; target_coin_id: string; trade_url: string; }[]; }`\n\n  - `country: string`\n  - `description: string`\n  - `image: string`\n  - `name: string`\n  - `number_of_futures_pairs: number`\n  - `number_of_perpetual_pairs: number`\n  - `open_interest_btc: number`\n  - `trade_volume_24h_btc: string`\n  - `url: string`\n  - `year_established: number`\n  - `tickers?: { base: string; bid_ask_spread: number; coin_id: string; contract_type: string; converted_last: { btc?: string; eth?: string; usd?: string; }; converted_volume: { btc?: string; eth?: string; usd?: string; }; expired_at: number; funding_rate: number; h24_percentage_change: number; h24_volume: number; index: number; index_basis_percentage: number; last: number; last_traded: number; open_interest_usd: number; symbol: string; target: string; target_coin_id: string; trade_url: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.derivatives.exchanges.getID('id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { active_cryptocurrencies: number; ended_icos: number; market_cap_change_percentage_24h_usd: number; market_cap_percentage: object; markets: number; ongoing_icos: number; total_market_cap: object; total_volume: object; upcoming_icos: number; updated_at: number; volume_change_percentage_24h_usd: number; }; }',
    markdown:
  ...
  },
  {
    ...
    stainlessPath: '(resource) insights > (method) get',
    qualified: 'client.insights.get',
    params: ['coin_id?: string;', 'from?: string;', 'page?: number;', 'per_page?: number;', 'to?: string;'],
    response: '{ description: string; posted_at: string; related_coin_ids: string[]; title: string; }[]',
    markdown:
      "## get\n\n`client.insights.get(coin_id?: string, from?: string, page?: number, per_page?: number, to?: string): { description: string; posted_at: string; related_coin_ids: string[]; title: string; }[]`\n\n**get** `/insights`\n\nTo query the latest coin insights on CoinGecko\n\n### Parameters\n\n- `coin_id?: string`\n  Filter insights by coin ID. \n*refers to [`/coins/list`](/reference/coins-list).\n\n- `from?: string`\n  Starting date in ISO date string (`YYYY-MM-DD`).\n\n- `page?: number`\n  Page through results. \nDefault value: 1 \nValid values: 1...20\n\n- `per_page?: number`\n  Total results per page. \nDefault value: 10 \nValid values: 1...20\n\n- `to?: string`\n  Ending date in ISO date string (`YYYY-MM-DD`).\n\n### Returns\n\n- `{ description: string; posted_at: string; related_coin_ids: string[]; title: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst insights = await client.insights.get();\n\nconsole.log(insights);\n```",
    perLanguage: {
      typescript: {
        method: 'client.insights.get',
        example:
          "import Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko({\n  proAPIKey: process.env['COINGECKO_PRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst insights = await client.insights.get();\n\nconsole.log(insights);",
      },
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/insights \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'insights.get',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\ninsights = client.insights.get()\nprint(insights)',
      },
    },
  },
  {
    ...
    response:
      '{ api_key_current_total_monthly_calls: number; api_key_monthly_call_credit: number; api_key_rate_limit_request_per_minute: number; current_remaining_monthly_calls: number; current_total_monthly_calls: number; monthly_call_credit: number; plan: string; rate_limit_request_per_minute: number; }',
    markdown:
      "## get\n\n`client.key.get(): { api_key_current_total_monthly_calls: number; api_key_monthly_call_credit: number; api_key_rate_limit_request_per_minute: number; current_remaining_monthly_calls: number; current_total_monthly_calls: number; monthly_call_credit: number; plan: string; rate_limit_request_per_minute: number; }`\n\n**get** `/key`\n\nTo monitor your account's API usage, including rate limits, monthly total credits, remaining credits, and more\n\n### Returns\n\n- `{ api_key_current_total_monthly_calls: number; api_key_monthly_call_credit: number; api_key_rate_limit_request_per_minute: number; current_remaining_monthly_calls: number; current_total_monthly_calls: number; monthly_call_credit: number; plan: string; rate_limit_request_per_minute: number; }`\n\n  - `api_key_current_total_monthly_calls: number`\n  - `api_key_monthly_call_credit: number`\n  - `api_key_rate_limit_request_per_minute: number`\n  - `current_remaining_monthly_calls: number`\n  - `current_total_monthly_calls: number`\n  - `monthly_call_credit: number`\n  - `plan: string`\n  - `rate_limit_request_per_minute: number`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst key = await client.key.get();\n\nconsole.log(key);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## get_address\n\n`client.onchain.networks.pools.getAddress(network: string, address: string, include?: string, include_composition?: boolean, include_volume_breakdown?: boolean): { data: pool_address_item; included?: object[]; }`\n\n**get** `/onchain/networks/{network}/pools/{address}`\n\nTo query the specific pool based on the provided network and pool address\n\n### Parameters\n\n- `network: string`\n\n- `address: string`\n\n- `include?: string`\n  Attributes to include, comma-separated if more than one. \nAvailable values: `base_token`, `quote_token`, `dex`\n\n- `include_composition?: boolean`\n  Include pool composition. \nDefault: `false`\n\n- `include_volume_breakdown?: boolean`\n  Include volume breakdown. \nDefault: `false`\n\n### Returns\n\n- `{ data: { id: string; attributes: object; relationships: object; type: string; }; included?: { id?: string; attributes?: { address?: string; coingecko_coin_id?: string; decimals?: number; image_url?: string; name?: string; symbol?: string; }; type?: string; }[]; }`\n\n  - `data: { id: string; attributes: { address: string; base_token_price_native_currency: string; base_token_price_quote_token: string; base_token_price_usd: string; fdv_usd: string; locked_liquidity_percentage: string; market_cap_usd: string; name: string; pool_created_at: string; pool_fee_percentage: string; pool_name: string; price_change_percentage: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; quote_token_price_base_token: string; quote_token_price_native_currency: string; quote_token_price_usd: string; reserve_in_usd: string; transactions: { h1?: object; h24?: object; h6?: object; m15?: object; m30?: object; m5?: object; }; volume_usd: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; base_token_balance?: string; base_token_liquidity_usd?: string; buy_volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; net_buy_volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; quote_token_balance?: string; quote_token_liquidity_usd?: string; sell_volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; }; relationships: { base_token?: { data?: object; }; dex?: { data?: object; }; quote_token?: { data?: object; }; }; type: string; }`\n  - `included?: { id?: string; attributes?: { address?: string; coingecko_coin_id?: string; decimals?: number; image_url?: string; name?: string; symbol?: string; }; type?: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.onchain.networks.pools.getAddress('address', { network: 'network' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; attributes: { address: string; banner_image_url: string; categories: string[]; coingecko_coin_id: string; decimals: number; description: string; developer_address: string; developer_holding_percentage: string; discord_url: string; farcaster_url: string; freeze_authority: string; gt_category_ids: string[]; gt_score: number; gt_score_details: object; gt_verified: boolean; holders: object; image: object; image_url: string; is_honeypot: boolean | string; mint_authority: string; name: string; symbol: string; telegram_handle: string; twitter_handle: string; websites: string[]; zora_url: string; }; relationships: { pool?: object; }; type: string; }[]; included?: { id?: string; attributes?: { base_token_address?: string; community_sus_report?: number; quote_token_address?: string; quote_token_addresses?: string[]; sentiment_vote_negative_percentage?: number; sentiment_vote_positive_percentage?: number; }; type?: string; }[]; }',
    markdown:
      "## get\n\n`client.onchain.networks.pools.info.get(network: string, pool_address: string, include?: 'pool'): { data: object[]; included?: object[]; }`\n\n**get** `/onchain/networks/{network}/pools/{pool_address}/info`\n\nTo query pool metadata (base and quote token details, image, socials, websites, description, contract address, etc.) based on a provided pool contract address on a network\n\n### Parameters\n\n- `network: string`\n\n- `pool_address: string`\n\n- `include?: 'pool'`\n  Attributes to include.\n\n### Returns\n\n- `{ data: { id: string; attributes: { address: string; banner_image_url: string; categories: string[]; coingecko_coin_id: string; decimals: number; description: string; developer_address: string; developer_holding_percentage: string; discord_url: string; farcaster_url: string; freeze_authority: string; gt_category_ids: string[]; gt_score: number; gt_score_details: object; gt_verified: boolean; holders: object; image: object; image_url: string; is_honeypot: boolean | string; mint_authority: string; name: string; symbol: string; telegram_handle: string; twitter_handle: string; websites: string[]; zora_url: string; }; relationships: { pool?: object; }; type: string; }[]; included?: { id?: string; attributes?: { base_token_address?: string; community_sus_report?: number; quote_token_address?: string; quote_token_addresses?: string[]; sentiment_vote_negative_percentage?: number; sentiment_vote_positive_percentage?: number; }; type?: string; }[]; }`\n\n  - `data: { id: string; attributes: { address: string; banner_image_url: string; categories: string[]; coingecko_coin_id: string; decimals: number; description: string; developer_address: string; developer_holding_percentage: string; discord_url: string; farcaster_url: string; freeze_authority: string; gt_category_ids: string[]; gt_score: number; gt_score_details: { creation?: number; holders?: number; info?: number; pool?: number; transaction?: number; }; gt_verified: boolean; holders: { count?: number; distribution_percentage?: object; last_updated?: string; }; image: { large?: string; small?: string; thumb?: string; }; image_url: string; is_honeypot: boolean | string; mint_authority: string; name: string; symbol: string; telegram_handle: string; twitter_handle: string; websites: string[]; zora_url: string; }; relationships: { pool?: { data?: { id?: string; type?: string; }; }; }; type: string; }[]`\n  - `included?: { id?: string; attributes?: { base_token_address?: string; community_sus_report?: number; quote_token_address?: string; quote_token_addresses?: string[]; sentiment_vote_negative_percentage?: number; sentiment_vote_positive_percentage?: number; }; type?: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst info = await client.onchain.networks.pools.info.get('pool_address', { network: 'network' });\n\nconsole.log(info);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; attributes: object; relationships: object; type: string; }[]; included?: { id?: string; attributes?: { address?: string; coingecko_coin_id?: string; decimals?: number; image_url?: string; name?: string; symbol?: string; }; type?: string; }[]; }',
    markdown:
      "## get_addresses\n\n`client.onchain.networks.pools.multi.getAddresses(network: string, addresses: string, include?: string, include_composition?: boolean, include_volume_breakdown?: boolean): { data: pool_address_item[]; included?: object[]; }`\n\n**get** `/onchain/networks/{network}/pools/multi/{addresses}`\n\nTo query multiple pools based on the provided network and pool addresses\n\n### Parameters\n\n- `network: string`\n\n- `addresses: string`\n\n- `include?: string`\n  Attributes to include, comma-separated if more than one. \nAvailable values: `base_token`, `quote_token`, `dex`\n\n- `include_composition?: boolean`\n  Include pool composition. \nDefault: `false`\n\n- `include_volume_breakdown?: boolean`\n  Include volume breakdown. \nDefault: `false`\n\n### Returns\n\n- `{ data: { id: string; attributes: object; relationships: object; type: string; }[]; included?: { id?: string; attributes?: { address?: string; coingecko_coin_id?: string; decimals?: number; image_url?: string; name?: string; symbol?: string; }; type?: string; }[]; }`\n\n  - `data: { id: string; attributes: { address: string; base_token_price_native_currency: string; base_token_price_quote_token: string; base_token_price_usd: string; fdv_usd: string; locked_liquidity_percentage: string; market_cap_usd: string; name: string; pool_created_at: string; pool_fee_percentage: string; pool_name: string; price_change_percentage: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; quote_token_price_base_token: string; quote_token_price_native_currency: string; quote_token_price_usd: string; reserve_in_usd: string; transactions: { h1?: object; h24?: object; h6?: object; m15?: object; m30?: object; m5?: object; }; volume_usd: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; base_token_balance?: string; base_token_liquidity_usd?: string; buy_volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; net_buy_volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; quote_token_balance?: string; quote_token_liquidity_usd?: string; sell_volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; }; relationships: { base_token?: { data?: object; }; dex?: { data?: object; }; quote_token?: { data?: object; }; }; type: string; }[]`\n  - `included?: { id?: string; attributes?: { address?: string; coingecko_coin_id?: string; decimals?: number; image_url?: string; name?: string; symbol?: string; }; type?: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.onchain.networks.pools.multi.getAddresses('addresses', { network: 'network' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; attributes: object; relationships: object; type: string; }; included?: { id?: string; attributes?: { address?: string; base_token_price_native_currency?: string; base_token_price_quote_token?: string; base_token_price_usd?: string; fdv_usd?: string; last_trade_timestamp?: string; market_cap_usd?: string; name?: string; pool_created_at?: string; price_change_percentage?: object; quote_token_price_base_token?: string; quote_token_price_native_currency?: string; quote_token_price_usd?: string; reserve_in_usd?: string; token_price_usd?: string; transactions?: object; volume_usd?: object; }; relationships?: { base_token?: object; dex?: object; quote_token?: object; }; type?: string; }[]; }',
    markdown:
      "## get_address\n\n`client.onchain.networks.tokens.getAddress(network: string, address: string, include?: 'top_pools', include_composition?: boolean, include_inactive_source?: boolean): { data: token_item; included?: object[]; }`\n\n**get** `/onchain/networks/{network}/tokens/{address}`\n\nTo query specific token data based on the provided token contract address on a network\n\n### Parameters\n\n- `network: string`\n\n- `address: string`\n\n- `include?: 'top_pools'`\n  Attributes to include.\n\n- `include_composition?: boolean`\n  Include pool composition. \nDefault: `false`\n\n- `include_inactive_source?: boolean`\n  Include token data from inactive pools using the most recent swap. \nDefault: `false`\n\n### Returns\n\n- `{ data: { id: string; attributes: object; relationships: object; type: string; }; included?: { id?: string; attributes?: { address?: string; base_token_price_native_currency?: string; base_token_price_quote_token?: string; base_token_price_usd?: string; fdv_usd?: string; last_trade_timestamp?: string; market_cap_usd?: string; name?: string; pool_created_at?: string; price_change_percentage?: object; quote_token_price_base_token?: string; quote_token_price_native_currency?: string; quote_token_price_usd?: string; reserve_in_usd?: string; token_price_usd?: string; transactions?: object; volume_usd?: object; }; relationships?: { base_token?: object; dex?: object; quote_token?: object; }; type?: string; }[]; }`\n\n  - `data: { id: string; attributes: { address: string; coingecko_coin_id: string; decimals: number; fdv_usd: string; image_url: string; market_cap_usd: string; name: string; normalized_total_supply: string; price_usd: string; symbol: string; total_reserve_in_usd: string; total_supply: string; volume_usd: { h24?: string; }; last_trade_timestamp?: string; launchpad_details?: { completed?: boolean; completed_at?: string; graduation_percentage?: number; migrated_destination_pool_address?: string; }; }; relationships: { top_pools?: { data?: object[]; }; }; type: string; }`\n  - `included?: { id?: string; attributes?: { address?: string; base_token_price_native_currency?: string; base_token_price_quote_token?: string; base_token_price_usd?: string; fdv_usd?: string; last_trade_timestamp?: string; market_cap_usd?: string; name?: string; pool_created_at?: string; price_change_percentage?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; quote_token_price_base_token?: string; quote_token_price_native_currency?: string; quote_token_price_usd?: string; reserve_in_usd?: string; token_price_usd?: string; transactions?: { h1?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; h24?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; h6?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; m15?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; m30?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; m5?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; }; volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; }; relationships?: { base_token?: { data?: { id?: string; type?: string; }; }; dex?: { data?: { id?: string; type?: string; }; }; quote_token?: { data?: { id?: string; type?: string; }; }; }; type?: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.onchain.networks.tokens.getAddress('address', { network: 'network' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ data: { id: string; attributes: object; relationships: object; type: string; }[]; included?: { id?: string; attributes?: { address?: string; base_token_price_native_currency?: string; base_token_price_quote_token?: string; base_token_price_usd?: string; fdv_usd?: string; market_cap_usd?: string; name?: string; pool_created_at?: string; price_change_percentage?: object; quote_token_price_base_token?: string; quote_token_price_native_currency?: string; quote_token_price_usd?: string; reserve_in_usd?: string; transactions?: object; volume_usd?: object; }; relationships?: { base_token?: object; dex?: object; quote_token?: object; }; type?: string; }[]; }',
    markdown:
      "## get_addresses\n\n`client.onchain.networks.tokens.multi.getAddresses(network: string, addresses: string, include?: 'top_pools', include_composition?: boolean, include_inactive_source?: boolean): { data: token_item[]; included?: object[]; }`\n\n**get** `/onchain/networks/{network}/tokens/multi/{addresses}`\n\nTo query multiple tokens data based on the provided token contract addresses on a network\n\n### Parameters\n\n- `network: string`\n\n- `addresses: string`\n\n- `include?: 'top_pools'`\n  Attributes to include.\n\n- `include_composition?: boolean`\n  Include pool composition. \nDefault: `false`\n\n- `include_inactive_source?: boolean`\n  Include tokens from inactive pools using the most recent swap. \nDefault: `false`\n\n### Returns\n\n- `{ data: { id: string; attributes: object; relationships: object; type: string; }[]; included?: { id?: string; attributes?: { address?: string; base_token_price_native_currency?: string; base_token_price_quote_token?: string; base_token_price_usd?: string; fdv_usd?: string; market_cap_usd?: string; name?: string; pool_created_at?: string; price_change_percentage?: object; quote_token_price_base_token?: string; quote_token_price_native_currency?: string; quote_token_price_usd?: string; reserve_in_usd?: string; transactions?: object; volume_usd?: object; }; relationships?: { base_token?: object; dex?: object; quote_token?: object; }; type?: string; }[]; }`\n\n  - `data: { id: string; attributes: { address: string; coingecko_coin_id: string; decimals: number; fdv_usd: string; image_url: string; market_cap_usd: string; name: string; normalized_total_supply: string; price_usd: string; symbol: string; total_reserve_in_usd: string; total_supply: string; volume_usd: { h24?: string; }; last_trade_timestamp?: string; launchpad_details?: { completed?: boolean; completed_at?: string; graduation_percentage?: number; migrated_destination_pool_address?: string; }; }; relationships: { top_pools?: { data?: object[]; }; }; type: string; }[]`\n  - `included?: { id?: string; attributes?: { address?: string; base_token_price_native_currency?: string; base_token_price_quote_token?: string; base_token_price_usd?: string; fdv_usd?: string; market_cap_usd?: string; name?: string; pool_created_at?: string; price_change_percentage?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; quote_token_price_base_token?: string; quote_token_price_native_currency?: string; quote_token_price_usd?: string; reserve_in_usd?: string; transactions?: { h1?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; h24?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; h6?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; m15?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; m30?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; m5?: { buyers?: number; buys?: number; sellers?: number; sells?: number; }; }; volume_usd?: { h1?: string; h24?: string; h6?: string; m15?: string; m30?: string; m5?: string; }; }; relationships?: { base_token?: { data?: { id?: string; type?: string; }; }; dex?: { data?: { id?: string; type?: string; }; }; quote_token?: { data?: { id?: string; type?: string; }; }; }; type?: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.onchain.networks.tokens.multi.getAddresses('addresses', { network: 'network' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## get\n\n`client.onchain.networks.tokens.topHolders.get(network: string, address: string, holders?: string, include_pnl_details?: boolean): { data: object; }`\n\n**get** `/onchain/networks/{network}/tokens/{address}/top_holders`\n\nTo query top token holders based on the provided token contract address on a network\n\n### Parameters\n\n- `network: string`\n\n- `address: string`\n\n- `holders?: string`\n  Number of top token holders to return, any integer or `max`. \nDefault value: 10\n\n- `include_pnl_details?: boolean`\n  Include PnL details for token holders. \nDefault: `false`\n\n### Returns\n\n- `{ data: { id: string; attributes: { holders: object[]; last_updated_at: string; }; type: string; }; }`\n\n  - `data: { id: string; attributes: { holders: { address: string; amount: string; label: string; percentage: string; rank: number; value: string; average_buy_price_usd?: string; explorer_url?: string; realized_pnl_percentage?: string; realized_pnl_usd?: string; total_buy_count?: number; total_sell_count?: number; unrealized_pnl_percentage?: string; unrealized_pnl_usd?: string; }[]; last_updated_at: string; }; type: string; }`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst topHolder = await client.onchain.networks.tokens.topHolders.get('address', { network: 'network' });\n\nconsole.log(topHolder);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## get\n\n`client.onchain.networks.tokens.topTraders.get(network_id: string, token_address: string, include_address_label?: boolean, sort?: string, traders?: string): { data: object; }`\n\n**get** `/onchain/networks/{network_id}/tokens/{token_address}/top_traders`\n\nTo query top token traders based on the provided token contract address on a network\n\n### Parameters\n\n- `network_id: string`\n\n- `token_address: string`\n\n- `include_address_label?: boolean`\n  Include address label data. \nDefault: `false`\n\n- `sort?: string`\n  Sort the traders by field. \nDefault: `realized_pnl_usd_desc`\n\n- `traders?: string`\n  Number of top token traders to return, any integer or `max`. \nDefault value: 10\n\n### Returns\n\n- `{ data: { id: string; attributes: { traders: object[]; }; type: string; }; }`\n\n  - `data: { id: string; attributes: { traders: { address: string; average_buy_price_usd: string; average_sell_price_usd: string; explorer_url: string; realized_pnl_usd: string; token_balance: string; total_buy_count: number; total_buy_token_amount: string; total_buy_usd: string; total_sell_count: number; total_sell_token_amount: string; total_sell_usd: string; unrealized_pnl_usd: string; label?: string; name?: string; type?: string; }[]; }; type: string; }`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst topTrader = await client.onchain.networks.tokens.topTraders.get('token_address', { network_id: 'network_id' });\n\nconsole.log(topTrader);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) rwas > (method) get_list',
    qualified: 'client.rwas.getList',
    params: ["asset_type?: 'stock' | 'commodity' | 'etf';"],
    response: "{ id: string; asset_type: 'stock' | 'commodity' | 'etf'; name: string; symbol: string; }[]",
    markdown:
      "## get_list\n\n`client.rwas.getList(asset_type?: 'stock' | 'commodity' | 'etf'): { id: string; asset_type: 'stock' | 'commodity' | 'etf'; name: string; symbol: string; }[]`\n\n**get** `/rwas/list`\n\nTo query all the supported tokenized real world assets (RWAs) on CoinGecko with RWA ID, name and symbol\n\n### Parameters\n\n- `asset_type?: 'stock' | 'commodity' | 'etf'`\n  Filter by RWA asset type.\n\n### Returns\n\n- `{ id: string; asset_type: 'stock' | 'commodity' | 'etf'; name: string; symbol: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.rwas.getList();\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.rwas.getList',
        example:
          "import Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko({\n  proAPIKey: process.env['COINGECKO_PRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.rwas.getList();\n\nconsole.log(response);",
      },
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/rwas/list \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'rwas.get_list',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.rwas.get_list()\nprint(response)',
      },
    },
  },
  {
    name: 'get_markets',
    endpoint: '/rwas/markets',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) rwas > (method) get_markets',
    qualified: 'client.rwas.getMarkets',
    params: [
      "asset_type?: 'stock' | 'commodity' | 'etf';",
      'ids?: string;',
      'issuer?: string;',
  ...
  },
  {
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/rwas/$ID \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'rwas.get_id',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.rwas.get_id(\n    id="id",\n)\nprint(response.id)',
      },
    },
  },
  {
    name: 'get_list',
    endpoint: '/rwas/issuers/list',
    httpMethod: 'get',
    summary: 'RWA Issuers List',
    description: 'To query all the supported RWA issuers on CoinGecko',
    stainlessPath: '(resource) rwas.issuers > (method) get_list',
    qualified: 'client.rwas.issuers.getList',
    response: '{ id: string; name: string; }[]',
    markdown:
      "## get_list\n\n`client.rwas.issuers.getList(): { id: string; name: string; }[]`\n\n**get** `/rwas/issuers/list`\n\nTo query all the supported RWA issuers on CoinGecko\n\n### Returns\n\n- `{ id: string; name: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.rwas.issuers.getList();\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.rwas.issuers.getList',
        example:
          "import Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko({\n  proAPIKey: process.env['COINGECKO_PRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.rwas.issuers.getList();\n\nconsole.log(response);",
      },
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/rwas/issuers/list \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'rwas.issuers.get_list',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.rwas.issuers.get_list()\nprint(response)',
      },
    },
  },
  {
    name: 'get_id',
    endpoint: '/rwas/issuers/{id}',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) rwas.issuers > (method) get_id',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/rwas/issuers/$ID \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'rwas.issuers.get_id',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.rwas.issuers.get_id(\n    "id",\n)\nprint(response.id)',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/rwas/{id}/market_chart',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) rwas.market_chart > (method) get',
    qualified: 'client.rwas.marketChart.get',
    params: ['id: string;', 'days?: string;', "interval?: '5m' | 'hourly' | 'daily';", 'precision?: string;'],
    response:
      '{ tokenized_market_caps: number[][]; tokenized_prices: number[][]; tokenized_total_volumes: number[][]; }',
    markdown:
      "## get\n\n`client.rwas.marketChart.get(id: string, days?: string, interval?: '5m' | 'hourly' | 'daily', precision?: string): { tokenized_market_caps: number[][]; tokenized_prices: number[][]; tokenized_total_volumes: number[][]; }`\n\n**get** `/rwas/{id}/market_chart`\n\nTo get the historical chart data of a RWA including time in UNIX, price, market cap and 24hrs volume based on a particular RWA ID\n\n### Parameters\n\n- `id: string`\n\n- `days?: string`\n  Data up to number of days ago. \nYou may use any integer or `max` for number of days. \nDefault: 1\n\n- `interval?: '5m' | 'hourly' | 'daily'`\n  Data interval, leave empty for auto granularity.\n\n- `precision?: string`\n  Decimal place for currency price value.\n\n### Returns\n\n- `{ tokenized_market_caps: number[][]; tokenized_prices: number[][]; tokenized_total_volumes: number[][]; }`\n\n  - `tokenized_market_caps: number[][]`\n  - `tokenized_prices: number[][]`\n  - `tokenized_total_volumes: number[][]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst marketChart = await client.rwas.marketChart.get('id');\n\nconsole.log(marketChart);\n```",
    perLanguage: {
      typescript: {
        method: 'client.rwas.marketChart.get',
        example:
          "import Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko({\n  proAPIKey: process.env['COINGECKO_PRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst marketChart = await client.rwas.marketChart.get('id');\n\nconsole.log(marketChart.tokenized_market_caps);",
      },
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/rwas/$ID/market_chart \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'rwas.market_chart.get',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nmarket_chart = client.rwas.market_chart.get(\n    id="id",\n)\nprint(market_chart.tokenized_market_caps)',
      },
    },
  },
  {
    name: 'get',
    endpoint: '/rwas/{id}/tickers',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) rwas.tickers > (method) get',
    qualified: 'client.rwas.tickers.get',
    params: [
      'id: string;',
      'depth?: boolean;',
      "dex_pair_format?: 'contract_address' | 'symbol';",
    ...
    response:
      '{ name: string; tickers: { base: string; bid_ask_spread_percentage: number; coin_id: string; coin_mcap_usd: number; converted_last: { btc?: number; eth?: number; usd?: number; }; converted_volume: { btc?: number; eth?: number; usd?: number; }; is_anomaly: boolean; is_stale: boolean; last: number; last_fetch_at: string; last_traded_at: string; market: { has_trading_incentive?: boolean; identifier?: string; logo?: string; name?: string; }; target: string; timestamp: string; token_info_url: string; trade_url: string; volume: number; cost_to_move_down_usd?: number; cost_to_move_up_usd?: number; target_coin_id?: string; }[]; }',
    markdown:
      "## get\n\n`client.rwas.tickers.get(id: string, depth?: boolean, dex_pair_format?: 'contract_address' | 'symbol', exchange_ids?: string, issuer_ids?: string, order?: 'last_traded_at_desc' | 'last_traded_at_asc' | 'volume_desc' | 'volume_asc', page?: number): { name: string; tickers: object[]; }`\n\n**get** `/rwas/{id}/tickers`\n\nTo query the RWA tokens tickers on both centralized exchange (CEX) and decentralized exchange (DEX) based on a particular RWA ID\n\n### Parameters\n\n- `id: string`\n\n- `depth?: boolean`\n  Include 2% orderbook depth, i.e. `cost_to_move_up_usd` and `cost_to_move_down_usd`. \nDefault: false\n\n- `dex_pair_format?: 'contract_address' | 'symbol'`\n  Set to `symbol` to display DEX pair base and target as symbols. \nDefault: `contract_address`\n\n- `exchange_ids?: string`\n  Exchange ID. \n*refers to [`/exchanges/list`](/reference/exchanges-list)\n\n- `issuer_ids?: string`\n  Issuer ID. \n*refers to [`/rwas/issuers/list`](/reference/rwas-issuers-list)\n\n- `order?: 'last_traded_at_desc' | 'last_traded_at_asc' | 'volume_desc' | 'volume_asc'`\n  Sort the order of responses. \nDefault: last_traded_at_desc\n\n- `page?: number`\n  Page through results\n\n### Returns\n\n- `{ name: string; tickers: { base: string; bid_ask_spread_percentage: number; coin_id: string; coin_mcap_usd: number; converted_last: { btc?: number; eth?: number; usd?: number; }; converted_volume: { btc?: number; eth?: number; usd?: number; }; is_anomaly: boolean; is_stale: boolean; last: number; last_fetch_at: string; last_traded_at: string; market: { has_trading_incentive?: boolean; identifier?: string; logo?: string; name?: string; }; target: string; timestamp: string; token_info_url: string; trade_url: string; volume: number; cost_to_move_down_usd?: number; cost_to_move_up_usd?: number; target_coin_id?: string; }[]; }`\n\n  - `name: string`\n  - `tickers: { base: string; bid_ask_spread_percentage: number; coin_id: string; coin_mcap_usd: number; converted_last: { btc?: number; eth?: number; usd?: number; }; converted_volume: { btc?: number; eth?: number; usd?: number; }; is_anomaly: boolean; is_stale: boolean; last: number; last_fetch_at: string; last_traded_at: string; market: { has_trading_incentive?: boolean; identifier?: string; logo?: string; name?: string; }; target: string; timestamp: string; token_info_url: string; trade_url: string; volume: number; cost_to_move_down_usd?: number; cost_to_move_up_usd?: number; target_coin_id?: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst ticker = await client.rwas.tickers.get('id');\n\nconsole.log(ticker);\n```",
    perLanguage: {
      typescript: {
        method: 'client.rwas.tickers.get',
        example:
          "import Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko({\n  proAPIKey: process.env['COINGECKO_PRO_API_KEY'], // This is the default and can be omitted\n});\n\nconst ticker = await client.rwas.tickers.get('id');\n\nconsole.log(ticker.name);",
      },
      http: {
        example:
          'curl https://pro-api.coingecko.com/api/v3/rwas/$ID/tickers \\\n    -H "x-cg-pro-api-key: $COINGECKO_PRO_API_KEY"',
      },
      python: {
        method: 'rwas.tickers.get',
        example:
          'import os\nfrom coingecko_sdk import Coingecko\n\nclient = Coingecko(\n    pro_api_key=os.environ.get("COINGECKO_PRO_API_KEY"),  # This is the default and can be omitted\n)\nticker = client.rwas.tickers.get(\n    id="id",\n)\nprint(ticker.name)',
      },
    },
  },
  {
    ...
    params: ['query: string;'],
    response:
      '{ categories: { id: string; name: string; }[]; coins: { id: string; api_symbol: string; large: string; market_cap_rank: number; name: string; symbol: string; thumb: string; }[]; exchanges: { id: string; large: string; market_type: string; name: string; thumb: string; }[]; icos: {  }[]; nfts: { id: string; name: string; symbol: string; thumb: string; }[]; }',
    markdown:
      "## get\n\n`client.search.get(query: string): { categories: object[]; coins: object[]; exchanges: object[]; icos: object[]; nfts: object[]; }`\n\n**get** `/search`\n\nTo search for coins, categories and markets listed on CoinGecko\n\n### Parameters\n\n- `query: string`\n  Search query\n\n### Returns\n\n- `{ categories: { id: string; name: string; }[]; coins: { id: string; api_symbol: string; large: string; market_cap_rank: number; name: string; symbol: string; thumb: string; }[]; exchanges: { id: string; large: string; market_type: string; name: string; thumb: string; }[]; icos: {  }[]; nfts: { id: string; name: string; symbol: string; thumb: string; }[]; }`\n\n  - `categories: { id: string; name: string; }[]`\n  - `coins: { id: string; api_symbol: string; large: string; market_cap_rank: number; name: string; symbol: string; thumb: string; }[]`\n  - `exchanges: { id: string; large: string; market_type: string; name: string; thumb: string; }[]`\n  - `icos: {  }[]`\n  - `nfts: { id: string; name: string; symbol: string; thumb: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst search = await client.search.get({ query: 'query' });\n\nconsole.log(search);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ categories: { id: number; coins_count: string; data: { market_cap: number; market_cap_btc: number; market_cap_change_percentage_24h: object; sparkline: string; total_volume: number; total_volume_btc: number; }; market_cap_1h_change: number; name: string; slug: string; top_3_coins_images: string[]; }[]; coins: { item: { id: string; coin_id: number; data: object; large: string; market_cap_rank: number; name: string; price_btc: number; score: number; slug: string; small: string; symbol: string; thumb: string; }; }[]; nfts: { id: string; data: { content: object; floor_price: string; floor_price_in_usd_24h_percentage_change: string; h24_average_sale_price: string; h24_volume: string; sparkline: string; }; floor_price_24h_percentage_change: number; floor_price_in_native_currency: number; name: string; native_currency_symbol: string; nft_contract_id: number; symbol: string; thumb: string; }[]; }',
    markdown:
      "## get\n\n`client.search.trending.get(show_max?: string): { categories: object[]; coins: object[]; nfts: object[]; }`\n\n**get** `/search/trending`\n\nTo query trending search coins, NFTs and categories on CoinGecko in the last 24 hours\n\n### Parameters\n\n- `show_max?: string`\n  Show max number of results available for the given type. \nAvailable values: `coins`, `nfts`, `categories` \ne.g. `coins` or `coins,nfts,categories`\n\n### Returns\n\n- `{ categories: { id: number; coins_count: string; data: { market_cap: number; market_cap_btc: number; market_cap_change_percentage_24h: object; sparkline: string; total_volume: number; total_volume_btc: number; }; market_cap_1h_change: number; name: string; slug: string; top_3_coins_images: string[]; }[]; coins: { item: { id: string; coin_id: number; data: object; large: string; market_cap_rank: number; name: string; price_btc: number; score: number; slug: string; small: string; symbol: string; thumb: string; }; }[]; nfts: { id: string; data: { content: object; floor_price: string; floor_price_in_usd_24h_percentage_change: string; h24_average_sale_price: string; h24_volume: string; sparkline: string; }; floor_price_24h_percentage_change: number; floor_price_in_native_currency: number; name: string; native_currency_symbol: string; nft_contract_id: number; symbol: string; thumb: string; }[]; }`\n\n  - `categories: { id: number; coins_count: string; data: { market_cap: number; market_cap_btc: number; market_cap_change_percentage_24h: object; sparkline: string; total_volume: number; total_volume_btc: number; }; market_cap_1h_change: number; name: string; slug: string; top_3_coins_images: string[]; }[]`\n  - `coins: { item: { id: string; coin_id: number; data: { content: { description?: string; title?: string; }; market_cap: string; market_cap_btc: string; price: number; price_btc: string; price_change_percentage_24h: object; sparkline: string; total_volume: string; total_volume_btc: string; }; large: string; market_cap_rank: number; name: string; price_btc: number; score: number; slug: string; small: string; symbol: string; thumb: string; }; }[]`\n  - `nfts: { id: string; data: { content: { description?: string; title?: string; }; floor_price: string; floor_price_in_usd_24h_percentage_change: string; h24_average_sale_price: string; h24_volume: string; sparkline: string; }; floor_price_24h_percentage_change: number; floor_price_in_native_currency: number; name: string; native_currency_symbol: string; nft_contract_id: number; symbol: string; thumb: string; }[]`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst trending = await client.search.trending.get();\n\nconsole.log(trending);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: 'object',
    markdown:
      "## get_id\n\n`client.simple.tokenPrice.getID(id: string, contract_addresses: string, vs_currencies: string, include_24hr_change?: boolean, include_24hr_vol?: boolean, include_last_updated_at?: boolean, include_market_cap?: boolean, precision?: string): object`\n\n**get** `/simple/token_price/{id}`\n\nTo query one or more token prices by using their token contract addresses\n\n### Parameters\n\n- `id: string`\n\n- `contract_addresses: string`\n  Token contract addresses, comma-separated if querying more than 1 token\n\n- `vs_currencies: string`\n  Target currency of coins, comma-separated if querying more than 1 currency. \n*refers to [`/simple/supported_vs_currencies`](/reference/simple-supported-currencies)\n\n- `include_24hr_change?: boolean`\n  Include 24-hour change percentage. \nDefault: false\n\n- `include_24hr_vol?: boolean`\n  Include 24-hour trading volume. \nDefault: false\n\n- `include_last_updated_at?: boolean`\n  Include last updated price time as a UNIX timestamp. \nDefault: false\n\n- `include_market_cap?: boolean`\n  Include market capitalization. \nDefault: false\n\n- `precision?: string`\n  Decimal places for currency price value\n\n### Returns\n\n- `object`\n\n### Example\n\n```typescript\nimport Coingecko from '@coingecko/coingecko-typescript';\n\nconst client = new Coingecko();\n\nconst response = await client.simple.tokenPrice.getID('id', { contract_addresses: 'contract_addresses', vs_currencies: 'vs_currencies' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
