...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    description: 'To query all the asset platforms (blockchain networks) on CoinGecko',
  ...
  },
  {
    ...
    description: 'To query all the coins categories on CoinGecko',
  ...
  },
  {
    ...
    description: 'To query all the derivatives exchanges with ID and name on CoinGecko',
  ...
  },
  {
    ...
    description: 'To query all the exchanges with ID and name',
  ...
  },
  {
    ...
    httpMethod: 'get',
    summary: 'Supported Networks List',
  ...
  },
  {
    ...
    httpMethod: 'get',
    summary: 'Supported Dexes List by Network',
    description:
