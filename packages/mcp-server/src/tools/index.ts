...
import get_coins_circulating_supply_chart from './coins/circulating-supply-chart/get-coins-circulating-supply-chart';
import get_range_coins_circulating_supply_chart from './coins/circulating-supply-chart/get-range-coins-circulating-supply-chart';
import get_coins_contract from './coins/contract/get-coins-contract';
import get_contract_coins_market_chart from './coins/contract/market-chart/get-contract-coins-market-chart';
...
import get_coins_market_chart from './coins/market-chart/get-coins-market-chart';
import get_range_coins_market_chart from './coins/market-chart/get-range-coins-market-chart';
import get_coins_ohlc from './coins/ohlc/get-coins-ohlc';
import get_range_coins_ohlc from './coins/ohlc/get-range-coins-ohlc';
import get_coins_tickers from './coins/tickers/get-coins-tickers';
import get_coins_total_supply_chart from './coins/total-supply-chart/get-coins-total-supply-chart';
import get_range_coins_total_supply_chart from './coins/total-supply-chart/get-range-coins-total-supply-chart';
import get_coin_id_companies_public_treasury from './companies/public-treasury/get-coin-id-companies-public-treasury';
import get_derivatives from './derivatives/get-derivatives';
import get_derivatives_exchanges from './derivatives/exchanges/get-derivatives-exchanges';
import get_id_derivatives_exchanges from './derivatives/exchanges/get-id-derivatives-exchanges';
import get_list_derivatives_exchanges from './derivatives/exchanges/get-list-derivatives-exchanges';
import get_exchange_rates from './exchange-rates/get-exchange-rates';
import get_exchanges from './exchanges/get-exchanges';
import get_id_exchanges from './exchanges/get-id-exchanges';
import get_list_exchanges from './exchanges/get-list-exchanges';
import get_exchanges_tickers from './exchanges/tickers/get-exchanges-tickers';
import get_exchanges_volume_chart from './exchanges/volume-chart/get-exchanges-volume-chart';
import get_range_exchanges_volume_chart from './exchanges/volume-chart/get-range-exchanges-volume-chart';
import get_global from './global/get-global';
import get_global_decentralized_finance_defi from './global/decentralized-finance-defi/get-global-decentralized-finance-defi';
import get_global_market_cap_chart from './global/market-cap-chart/get-global-market-cap-chart';
import get_key from './key/get-key';
import get_id_nfts from './nfts/get-id-nfts';
import get_list_nfts from './nfts/get-list-nfts';
import get_markets_nfts from './nfts/get-markets-nfts';
import get_contract_address_nfts_contract from './nfts/contract/get-contract-address-nfts-contract';
import get_contract_nfts_market_chart from './nfts/contract/market-chart/get-contract-nfts-market-chart';
import get_nfts_market_chart from './nfts/market-chart/get-nfts-market-chart';
import get_nfts_tickers from './nfts/tickers/get-nfts-tickers';
...
import get_tokens_onchain_info_recently_updated from './onchain/tokens/info-recently-updated/get-tokens-onchain-info-recently-updated';
import get_ping from './ping/get-ping';
...
import get_all_json_token_lists from './token-lists/get-all-json-token-lists';
...
addEndpoint(get_coins_circulating_supply_chart);
addEndpoint(get_range_coins_circulating_supply_chart);
addEndpoint(get_coins_contract);
addEndpoint(get_contract_coins_market_chart);
addEndpoint(get_range_contract_coins_market_chart);
addEndpoint(get_coins_history);
addEndpoint(get_coins_market_chart);
addEndpoint(get_range_coins_market_chart);
addEndpoint(get_coins_ohlc);
addEndpoint(get_range_coins_ohlc);
addEndpoint(get_coins_tickers);
addEndpoint(get_coins_total_supply_chart);
addEndpoint(get_range_coins_total_supply_chart);
addEndpoint(get_coin_id_companies_public_treasury);
addEndpoint(get_derivatives);
addEndpoint(get_derivatives_exchanges);
addEndpoint(get_id_derivatives_exchanges);
addEndpoint(get_list_derivatives_exchanges);
addEndpoint(get_exchange_rates);
addEndpoint(get_exchanges);
addEndpoint(get_id_exchanges);
addEndpoint(get_list_exchanges);
addEndpoint(get_exchanges_tickers);
addEndpoint(get_exchanges_volume_chart);
addEndpoint(get_range_exchanges_volume_chart);
addEndpoint(get_global);
addEndpoint(get_global_decentralized_finance_defi);
addEndpoint(get_global_market_cap_chart);
addEndpoint(get_key);
addEndpoint(get_id_nfts);
addEndpoint(get_list_nfts);
addEndpoint(get_markets_nfts);
addEndpoint(get_contract_address_nfts_contract);
addEndpoint(get_contract_nfts_market_chart);
addEndpoint(get_nfts_market_chart);
addEndpoint(get_nfts_tickers);
...
addEndpoint(get_tokens_onchain_info_recently_updated);
addEndpoint(get_ping);
...
addEndpoint(get_all_json_token_lists);
